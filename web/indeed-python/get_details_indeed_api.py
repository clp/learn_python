...
u'snippet': u'Focused on using the best of what lies at the
forefront of technology and data science to address answer
complex, real-world problems in the Healthcare and Life Science
space. BS or MS in Computer Science or a related field. Develop
tools to monitor, debug and analyze data pipelines. We are
looking for a Data Engineer to help build out our data
infrastructure using the best tools available so that...',
u'source': u'Komodo Health', u'state': u'CA', u'sponsored': False,
u'country': u'US', u'formattedLocation': u'San Francisco, CA',
u'jobkey': u'e8930d8d162c4b70', u'recommendations': [],
u'expired': False, u'indeedApply': True}
'''
