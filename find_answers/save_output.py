...
def save_full_search_output(qa_with_keyword_df, keyword):
    """Save the dataframe with Q&A groups that contain the search keyword
    ...
    wr.write_df_to_csv(qa_with_keyword_df, DATADIR, search_fname)
    #
    ...
    wr.write_df_to_html(qa_with_keyword_df, DATADIR, search_fname, columns_all_l)
    ...
    wr.write_df_to_html(qa_with_keyword_df, DATADIR, search_fname, columns_l)
    print('NOTE: See search output in this file: ' + DATADIR + search_fname)
    #
